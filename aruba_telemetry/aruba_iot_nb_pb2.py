...
_TELEMETRY.fields_by_name['meta'].message_type = aruba_iot_types_pb2._META
_TELEMETRY.fields_by_name['reporter'].message_type = _REPORTER
_TELEMETRY.fields_by_name['reported'].message_type = aruba_iot_nb_telemetry_pb2._REPORTED
_TELEMETRY.fields_by_name['results'].message_type = aruba_iot_nb_action_results_pb2._ACTIONRESULT
_TELEMETRY.fields_by_name['characteristics'].message_type = aruba_iot_nb_characteristic_pb2._CHARACTERISTIC
_TELEMETRY.fields_by_name['bleData'].message_type = aruba_iot_nb_ble_data_pb2._BLEDATA
_TELEMETRY.fields_by_name['wifiData'].message_type = aruba_iot_nb_wifi_data_pb2._WIFIDATA
_TELEMETRY.fields_by_name['devCount'].message_type = aruba_iot_nb_device_count_pb2._DEVICECOUNT
_TELEMETRY.fields_by_name['status'].message_type = aruba_iot_nb_status_pb2._STATUS
